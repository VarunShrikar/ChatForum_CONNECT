...
def loginPage(request):
    ...
    context= {'page': page}
    return render(request,'forum/login_reg.html', context)
...
def registerUser(request):
    ...
    return render(request, 'forum/login_reg.html', {'form': form})
...
def activityPage(request):
    room_messages = Message.objects.all()
    return render(request, 'forum/activity.html', {'room_messages': room_messages})